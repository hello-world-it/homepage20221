...
%>
	<!-- attachment : 브라우저에서 다운 받는걸 알려줌 / Content-Description : JSP로 만든 데이터라는걸 알려줌-->
...
<style type="text/css"> <%-- JSP로 사용 시 style로 꾸밀 수 있다 --%>
body {
	font-size: 12px;
	margin-left: 0px;
	font-family: 돋움;
...
<body>
	...
	<table> <%-- 엑셀은 테이블형식으로 되어 있어서 JSP에서 테이블 형식으로 코드를 짜준다 --%>
	<thead>
		<tr>
			<th>번호</th>
			<th>신청자명</th>
