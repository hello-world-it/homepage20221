...
게시물 총 수 : <c:out value="${paginationInfo.totalRecordCount}" />건
		...
		<tbody>
			<c:forEach var="result" items="${resultList}">
				<tr>
					...
					<td>
						<c:url var="viewUrl" value="/crud3/select.do"> <%-- 아래의 a태그와 연결 --%>
					...
					<td>
						<c:url var="delUrl" value="/crud3/delete.do">
						<c:param name="crudId" value="${result.crudId}" />
						</c:url>
	...
	<div id="poging_div">
		<ul class="paging_align">
			<c:url var="pageUrl" value="/crud3/selectList.do?" /> <!-- jstl -->
	...
	<!-- 글쓰기 버튼은 List에서 노출 -->
	<a href="/crud3/crudRegist.do">글쓰기</a> 
