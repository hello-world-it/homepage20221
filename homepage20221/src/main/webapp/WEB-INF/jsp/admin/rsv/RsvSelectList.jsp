		...
		<div id="contents">
			...
			<div id="bbs_wrap">
				<div class="total">
					...
					현재페이지 <strong><c:out value="${paginationInfo.currentPageNo}" /></strong>/<c:out value="${paginationInfo.totalPageCount}" />
				</div>
				<div class="bbs_list">
					<table class="list_table">
						...
						<tbody>
							<c:forEach var="result" items="${resultList}" varStatus="status">
								<tr>
									<td class="num"><c:out value="${paginationInfo.totalRecordCouny - ((searchVO.pageIndex-1) * searchVO.pageUnit) - (status.count-1)}" /></td>
									<td class="tit">
									...
									<td>
										<a href="${updateUrl}" class="btn spot">수정</a><br/><br/>
